...
print "The length of the gene is", length


#We draw the gene
gene = Drawing("gene.svg", debug=True)#, size=('200mm', '150mm'), viewBox=('0 0 200 150'))
height = 70
x,y = 20,20
position = (x,y)
...
#We add legends
gene.add(Text("Intron", insert = (40,110), fill="dodgerblue"))
gene.add(Text("Exon", insert = (40,130), fill="slateblue"))
