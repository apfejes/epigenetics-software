...
if chip_first:
    # Collect waves data
    query_waves = m.query(collection = "waves", chromosome = "chr4", start = 3076407, end = 3245687)
    m.finddocs()
    m.getwaves()
    ...
    query_betas = m.query(collection = "methylation", chromosome = "chr4", start = 3076407, end = 3245687)
    m.finddocs()
    m.collectbetas()
