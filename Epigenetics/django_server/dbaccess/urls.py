...
#   url(r'^home$',views.index,name='index'),
    ...
    url(r'^deleteproject/', views.delete_project, name = 'delete_project'),
    url(r'^import/', views.import_metadata, name = 'import_metadata'),
    url(r'^import2/', views.import_files, name = 'import_files'),
    url(r'^import3/', views.import_process, name = 'import_process'),
